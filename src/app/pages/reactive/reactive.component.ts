...
export class ReactiveComponent implements OnInit {
  ...
  get pass2NoValido(){
    ...
    if(this.forma.get('pass1').pristine){
      return '';
    }else{
  ...
  crearFormulario(){
    ...
    this.forma = this.fb.group({
      ...
      apellido:['', [Validators.required, Validators.minLength(5), this.validadores.noCappellacci]],
  ...
  guardar(){
    ...
    //posteo de información a través de un servicio
  }
